...
// These functions are ignored because they are not marked as `pub`: `apply_dns_settings`, `apply_hardcoded_dns_overrides`, `apply_reqwest_tls_settings`, `build_ech_tls_config`, `build_reqwest_client`, `build_root_store`, `client_for_url`, `collect_pem_certificates`, `collect_root_cert_ders`, `create_client`, `extract_https_svc_param`, `hardcoded_ip_addrs`, `hardcoded_socket_addrs`, `lookup_alidns_https_ech`, `lookup_ech_config`, `new_default`, `new`, `new`, `parse_alidns_https_ech_response`, `parse_private_key`, `should_try_ech`
// These types are ignored because they are not used by any `pub` functions: `ClientRuntime`, `DynamicDnsSettings`, `DynamicResolver`, `EchTransport`, `NoVerifier`, `StaticResolver`
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `fmt`, `resolve`, `resolve`, `supported_verify_schemes`, `verify_server_cert`, `verify_tls12_signature`, `verify_tls13_signature`
